...
class ForgotVerifyCodePage extends StatefulWidget {
  const ForgotVerifyCodePage({super.key});

  @override
  State<ForgotVerifyCodePage> createState() => _ForgotVerifyCodePageState();
}

class _ForgotVerifyCodePageState extends State<ForgotVerifyCodePage> {
            ...
            children: [
              ...
              SizedBox(
                ...
                child: CustomElevatedButton(
                  ...
                  text: "Continue",
                  onPressed: () {
                    context.pushNamed(AppRoute.forgetCreatePassword);
                  },
                ),
              ),
            ],
