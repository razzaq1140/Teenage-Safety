...
class _GoldPageState extends State<GoldPage> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _tabController = TabController(length: 2, vsync: this); // 3 tabs ke liye controller
  }
